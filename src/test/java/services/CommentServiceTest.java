...
public class CommentServiceTest extends AbstractTest{
	...
	public void testgetCommentsFilterBan(){
		...
		Actor actor = this.actorService.findOne(55);
		
		this.authenticate(actor.getUserAccount().getUsername());
		
		Collection<Comment> todos = this.commentService.findAll();
		
		Collection<Comment> noBaneados = this.commentService.getCommentsFilterBan(todos);
		
		int baneados=todos.size()-noBaneados.size();
...
//		this.unauthenticate();
	...
	public void testgetCommentsFilterBanNull(){
		...
		Collection<Comment> noBaneados = this.commentService.getCommentsFilterBan(null);
	...
	public void testCreateAndSave(){
		...
		int comentariosActuales = this.commentService.findAll().size();
		
		Offer ofertaAComentar = this.offerService.findOne(60);
		
		Comment comentario= this.commentService.create(ofertaAComentar);
	...
	public void testCreateAndSaveNullCreate(){
		...
		Comment comentario= this.commentService.create(null);
//		comentario.setTitle("Comentario de prueba");
//		comentario.setText("Texto de prueba");
//		comentario.setStarsNumber(5);
//		
...
//		}
	...
	public void testBanComments(){
		...
		Comment comentario = this.commentService.findOne(90);
	...
	public void testDelete(){
		...
		Comment comentario = this.commentService.findOne(92);
