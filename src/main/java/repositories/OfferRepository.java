...
public interface OfferRepository extends JpaRepository<Offer, Integer> {
	...
	@Query("select o from Offer o where (o.title like ?1 or o.description like ?1 or o.originPlace.address like ?1 or o.destinationPlace.address like ?1) and o.banned=false")
